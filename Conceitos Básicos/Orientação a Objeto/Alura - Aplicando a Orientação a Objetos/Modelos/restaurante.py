...
'''
# print(dir(restaurantePraca))     #EXIBE OS ATRIBUTOS, MÉTODOS E PROPRIEDADES DE UM OBJETO, TANTO NATIVOS QUANTO DECLARADOS PELO USUÁRIO
# print(vars(restaurantePraca))    #EQUIVALE AO MÉTODO __dict__, RETORNA UM DICIONÁRIO DESSES ATRIBUTOS E MÉTODOS 
